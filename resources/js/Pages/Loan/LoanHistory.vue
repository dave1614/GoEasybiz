<template inheritAttrs="false">
  <LayoutAuthenticated>
    ...
    <Head title="Easy Loan History" />
    <SectionMain>
      <SectionTitleLineWithButton :icon="mdiClipboardTextClock" title="Easy Loan History" main>
...
const submitFilterForm = () => {
  ...
  let queryRoute = route('easy_loan_history_page', Object.keys(query).length ? query : {
    remember: 'forget'
  });
