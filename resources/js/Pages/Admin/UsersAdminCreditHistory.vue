<template inheritAttrs="false">
  <LayoutAuthenticated>
    ...
    <Head :title="`${user.name}'s Admin Credit History`" />
    <SectionMain>
      <SectionTitleLineWithButton :icon="mdiCashClock" :title="`${user.name}'s Admin Credit History`" main>
...
const submitFilterForm = () => {
  ...
  let queryRoute = route('users_admin_credit_history', user.id);
