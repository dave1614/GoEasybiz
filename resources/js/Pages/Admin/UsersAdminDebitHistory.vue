<template inheritAttrs="false">
  <LayoutAuthenticated>
    ...
    <Head :title="`${user.name}'s Admin Debit History`" />
    <SectionMain>
      <SectionTitleLineWithButton :icon="mdiCashClock" :title="`${user.name}'s Admin Debit History`" main>
...
const submitFilterForm = () => {
  ...
  let queryRoute = route('users_admin_debit_history', user.id);
