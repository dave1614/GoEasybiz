<template inheritAttrs="false">
  <LayoutAuthenticated>
    ...
    <FloatingActionButton  :title="'View Airtime Combo Recharge History'" @click="Inertia.visit(route('airtime_combo_recharge_history')) ">
...
const submitFilterForm = () => {
  ...
  let queryRoute = route('airtime_combo_requests');
