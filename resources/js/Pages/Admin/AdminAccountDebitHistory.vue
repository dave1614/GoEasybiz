<template inheritAttrs="false">
  <LayoutAuthenticated>
    ...
    <Head :title="`Admin Debit History`" />
    <SectionMain>
      <SectionTitleLineWithButton :icon="mdiClipboardTextClock" :title="`Admin Debit History`" main>
...
const submitFilterForm = () => {
  ...
  let queryRoute = route('account_debit_history', user.id);
