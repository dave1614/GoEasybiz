<template inheritAttrs="false">
  <LayoutAuthenticated>
    ...
    <Head :title="`${user.name}'s Earn. To Wallet`" />
    <SectionMain>
      <SectionTitleLineWithButton :icon="mdiCashClock" :title="`${user.name}'s Earn. To Wallet`" main>
...
const submitFilterForm = () => {
  ...
  let queryRoute = route('users_earnings_to_wallet', user.id);
