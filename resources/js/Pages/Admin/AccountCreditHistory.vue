<template inheritAttrs="false">
  <LayoutAuthenticated>
    ...
    <Head :title="`Account Credit History`" />
    <SectionMain>
      <SectionTitleLineWithButton :icon="mdiClipboardTextClock" :title="`Account Credit History`" main>
...
const submitFilterForm = () => {
  ...
  let queryRoute = route('account_credit_history', user.id);
