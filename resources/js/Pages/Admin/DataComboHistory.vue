<template inheritAttrs="false">
  <LayoutAuthenticated>
    ...
    <Head :title="`Data Combo History`" />
    <SectionMain>
      <SectionTitleLineWithButton :icon="mdiClipboardTextClock" :title="`Data Combo History`" main>
    ...
    <FloatingActionButton :title="'Go Back'" @click="Inertia.visit(route('data_combo_requests')) ">
...
const submitFilterForm = () => {
  ...
  let queryRoute = route('data_combo_recharge_history');
