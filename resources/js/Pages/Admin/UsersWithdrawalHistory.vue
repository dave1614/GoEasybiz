<template inheritAttrs="false">
  <LayoutAuthenticated>
    ...
    <Head :title="`${user.name}'s Withdrawal History`" />
    <SectionMain>
      <SectionTitleLineWithButton :icon="mdiCashClock" :title="`${user.name}'s Withdrawal History`" main>
...
const submitFilterForm = () => {
  ...
  let queryRoute = route('users_withdrawal_history', user.id);
