  ...
  <LayoutAuthenticated>
    ...
    <SectionMain>
      ...
      <CustomNotificationBar  color="success" :icon="mdiBellBadge">
        ...
        <span v-if="mainStore.email_changed"> But we noticed your email was changed. A link has been sent to your new email address. Click this link to finally update your email address.</span>
        ...
        <div class="sm:grid sm:grid-cols-12 sm:gap-6">
          ...
          <FormField class="sm:col-span-6" label="Phone">
            <div class="grid grid-cols-12 gap-6 my-3">
              ...
              <FormControl class="col-span-4" v-model="form.country" :options="countries" :error="form.errors.country" />
              ...
              <div class="col-span-8">
                <!-- <text-input v-model="form.phone" :error="form.errors.phone" type="number" label="Phone Number" id="phone"
                  placeholder="" /> -->
                  <FormControl v-model="form.phone" type="text" placeholder="Your phone number" :error="form.errors.phone"  />
              </div>
            </div>
          </FormField>
          ...
          <FormField class="sm:col-span-6" label="Address">
            <FormControl v-model="form.address" type="textarea" placeholder="Enter your address" :error="form.errors.address"/>
          </FormField>
        </div>
