<template inheritAttrs="false">
  <LayoutAuthenticated>
    ...
    <Head :title="`Earn. To Wall. His.`" />
    <SectionMain>
      <SectionTitleLineWithButton :icon="mdiCashClock" :title="`Earn. To Wall. His.`" main>
        <!-- <BaseButton :href="route('funds_withdrawal')" :icon="mdiFolderMinus" label="Funds Withdrawal" color="success"
          rounded-full small /> -->
...
const submitFilterForm = () => {
  ...
  let queryRoute = route('earning_to_wallet_hist', user.id);
