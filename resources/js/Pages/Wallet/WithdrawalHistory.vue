<template inheritAttrs="false">
  <LayoutAuthenticated>
    ...
    <SectionMain>
      <SectionTitleLineWithButton :icon="mdiCashClock" :title="`Withdrawal History`" main>
        <BaseButton :href="route('funds_withdrawal')" :icon="mdiFolderMinus"
          label="Funds Withdrawal" color="success" rounded-full small />
...
const submitFilterForm = () => {
  ...
  let queryRoute = route('withdrawal_history', user.id);
