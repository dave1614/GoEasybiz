...
const toggle = () => {
    mainStore.notiDismissed = !mainStore.notiDismissed;
    // emit('onDismiss', isDismissed.value)
};
...
<template>
    <div v-if="!mainStore.notiDismissed" :class="componentClass"
        ...
        <BaseLevel>
            ...
            <BaseButton v-else :icon="mdiClose" small rounded-full color="white" @click="toggle" />
        </BaseLevel>
    </div>
</template>
